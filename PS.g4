...
NOT_CMD: NOT L_BRACE VARIABLE R_BRACE;

EQUALITY_CMD: (VARIABLE | LETTER | GREEK_LETTER )+ (EQUAL | LT | LTE | GT | GTE | UNEQUAL | AND | OR ) (VARIABLE | LETTER | GREEK_LETTER | FUNC_LCM)+;
...
atom: (LETTER_NO_E | GREEK_LETTER | accent) subexpr? | SYMBOL | NUMBER | PERCENT_NUMBER | E_NOTATION | DIFFERENTIAL | mathit | VARIABLE | UNION | EPSILON | EQUALITY_CMD | INTERSECTION | PROPER_SUBSET | SUPERSET | SUBSET | INTERVAL | ABSOLUTE | NRT | NOT_CMD;
