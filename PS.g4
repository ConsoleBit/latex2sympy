...
fragment RELATION_CMD: (VARIABLE | LETTER | GREEK_LETTER | DIGIT )+ (LT|GT|LTE|GTE|EQUAL|UNEQUAL)+ (VARIABLE | LETTER | GREEK_LETTER | DIGIT )+;
...
fragment NOT_CMD: NOT L_BRACE (VARIABLE | DIGIT | LETTER | COMMA | EQUALITY_SET | NOT_CMD|AND_CMD|OR_CMD | NRT_CAL) R_BRACE;
fragment AND_CMD : AND L_BRACE (VARIABLE | DIGIT | LETTER | COMMA | EQUALITY_SET | NOT_CMD|AND_CMD|OR_CMD| NRT_CAL )+ R_BRACE;
fragment OR_CMD : OR L_BRACE (VARIABLE | DIGIT | LETTER | COMMA | EQUALITY_SET | NOT_CMD|AND_CMD|OR_CMD| NRT_CAL)+ R_BRACE;
...
atom: (LETTER_NO_E | GREEK_LETTER | accent) subexpr? | SYMBOL | NUMBER | PERCENT_NUMBER | E_NOTATION | DIFFERENTIAL | mathit | VARIABLE | EQUALITY_CMD | INTERVAL | ABSOLUTE | NRT | LOGICAL | SUMMATION | EQUIVALENCE  | SET_CMD | FOR_CMD | LEN_CMD | CONDITIONAL;
